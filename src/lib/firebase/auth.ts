  ...
  if (error instanceof FirebaseError) {
    switch (error.code) {
      ...
      case 'auth/wrong-password':
        return mode === 'signup' ? 'Email hoặc mật khẩu không hợp lệ.' : 'Email hoặc mật khẩu không đúng.';
      ...
      default:
        return mode === 'signup' ? 'Không thể đăng ký. Vui lòng thử lại.' : 'Không thể đăng nhập. Vui lòng thử lại.';
    }
  }
